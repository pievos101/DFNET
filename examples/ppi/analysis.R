...
module_node_matrix <- save_module_node_matrix[, apply(
    save_module_node_matrix,
    2,
    function(x) sum(x) > 0
)]
...
plot(
    x = clust_modules, main = "Clustering modules by them having similar variables",
...
plot(
    x = clust_nodes, main = "Clustering variables by them being in similar modules",
